...
> Age, comorbiditiesd, drug/alchool/nicotine use, genetic disorders in close family members, external events during pregnancy (e.g. increased dioxin levels in the environment, Chernobyl etc.) among other things.

5. Why do you think they designed the study as a case-control study and not a cohort study?

> Pregnancy may not occur at the same time in all case-control pairs. Gastroschisis is also a farily uncommon condition.
