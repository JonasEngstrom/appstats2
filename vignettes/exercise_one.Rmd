...
> The data is loaded in this document using the command `library(appstats2)` in the code chunk above. For the sourceode importing the data from the provided Excel file and formatting it as a tibble, please see the file [`bloospressure.R`](https://github.com/JonasEngstrom/appstats2/blob/main/data-raw/bloodpressure.R).
...
1. As a first task, we investigate the association between smoking and hypertension.
    ...
    # Manual calculation. Relative risk of hypertension for smoker vs non-smokers.
